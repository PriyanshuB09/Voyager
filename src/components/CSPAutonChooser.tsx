...
const CSPAutonChooser: React.FC<{setAutoCommands: any}> = ({setAutoCommands}) => {
    ...
    const [items, setItems] = useState<Item[]>(initialItems);
     ...
     useEffect(() => {
      ...
      const onDragOver = (e: React.DragEvent<HTMLLIElement>, overIndex: number) => {
        e.preventDefault();
...
export default CSPAutonChooser;